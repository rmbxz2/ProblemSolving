...
public class LeagueService {
  ...
  /**
   * This method returns the list of seasons titles
   */
  ...
  /**
   * This method returns the list of divisions titles
   */
  private static final String[] divisions = { "Amateur", "Semi-Pro", "Professional" };
