...
DELETE FROM league WHERE lid=5;

SELECT lid, year, season, title FROM League WHERE lid=8 ;

SELECT  lid, year, season, title FROM League ;


UPDATE League SET year = 2005, season = 'summer', title = 'updated title'  WHERE  lid = 8 ;

UPDATE League SET year = 2005, season = 'summer', title = 'updated title'  WHERE  lid = 8;

select league.lid from league.;
...
INSERT INTO  player (name,  address,  city,  province,  postal_code)  VALUES ('ahmad', 'jordan', 'zarka' ,'hi', '962');

SELECT name,  address,  city,  province,  postal_code FROM player  WHERE pid= 1;

SELECT name,  address,  city,  province,  postal_code FROM player ;



UPDATE Player SET name = ?, address = ?, city = ?, province=? , postal_code = ?  WHERE  pid = ? 

UPDATE Player SET name = 'ali', address = 'syria', city = 'amman', province='updated' , postal_code = '935'  WHERE  pid = 1 ;
